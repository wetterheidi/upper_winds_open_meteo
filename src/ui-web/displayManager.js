 ...
 * @returns {void}
 */
export function updateLandingPatternDisplayOLD(returnCoordsForExport = false) {
    ...
    if (returnCoordsForExport) {
        // Wenn die Funktion für den Export aufgerufen wird, geben wir die berechneten Punkte zurück.
        return {
            downwindEnd,
            baseEnd,
            finalEnd,
            dip: [markerLatLng.lat, markerLatLng.lng]
        };
    }
    ...
    mapManager.drawLandingPattern(patternData);
        return null; // Wenn gezeichnet wird, geben wir nichts zurück.
}
