...
export async function updateUIWithNewWeatherData(newWeatherData, preservedTime = null) {
    ...
    // preservedTime ist ein ISO-Zeitstempel (z.B. "2026-04-08T18:00") aus dem alten Datensatz.
    // Wir suchen den Index im neuen Datensatz, der diesem Zeitstempel am nächsten liegt.
    // Das funktioniert korrekt beim Modellwechsel (unterschiedliche Startzeiten).
...
function setupAppEventListeners() {
    ...
    document.addEventListener('pin:createPin', () => {
        ...
        // HARP-Popup aktualisieren (Pin-Zähler)
        ...
        try {
            ...
            if (newWeatherData) {
                ...
                if (isInitialLoad) {
                    ...
                    // Bei allen anderen Aktionen den zuvor geholten Zeitstempel beibehalten.
                    await updateUIWithNewWeatherData(newWeatherData, currentTimeToPreserve);
                }
            } else {
