...
function setupJumpRunTrackEvents() {
    ...
    if (directionInput) {
        ...
        directionInput.addEventListener('change', () => {
            ...
            // Das sorgt dafür, dass Exit-Kreise & Wurf sofort neu gezeichnet werden,
            // sobald das Feld verlassen oder Enter gedrückt wird.
...
function setupSelectEvents() {
    const selectIds = ['refLevel', 'heightUnit', 'temperatureUnit', 'windUnit', 'timeZone', 'coordFormat', 'downloadFormat', 'maxForecastTime', 'northReference']; // Hinzugefügt
    ...
    if (toggleButton) {
        toggleButton.addEventListener('click', () => {
            ...
            if (isDarkMode) {
                ...
                newTheme = 'dark';
                newBaseMapName = 'Esri Dark Gray'; // Deine neue dunkle Karte
            }
